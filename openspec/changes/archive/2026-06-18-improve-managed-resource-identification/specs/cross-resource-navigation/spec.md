...
Clicking any relationship link SHALL trigger navigation to that resource and automatically open its sliding drawer detail view. The sliding drawer header MUST provide visual context including provider logo, kind, and api group/version alongside the resource name.
